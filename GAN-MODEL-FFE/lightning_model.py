...
class LoadModel(pl.LightningModule):
    ...
    def __init__(self):
        ...
        self.decoder1=Decoder(resolution)
        self.decoder2=Decoder(resolution)
        self.decoder3=Decoder(resolution)
        self.decoder4=Decoder(resolution)
    ...
    def forward(self,batch):
        ...
        for i, (inputs,inp_variables, target) in enumerate(batch):
            ...
            latent,trans_shape=self.encoder(inputs,inp_variables)
    ...
    def training_step(self,batch, batch_idx):
        ...
        latent,trans_shape=self.encoder(inputs,inp_ops)
